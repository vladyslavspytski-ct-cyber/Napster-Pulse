...
const InterviewArchitectTest = () => {
  ...
  const [isIntroductionEdited, setIsIntroductionEdited] = useState(false);
  ...
  useEffect(() => {
    ...
    // Don't overwrite if user has edited
    if (isIntroductionEdited) {
      console.log("[Introduction] SKIP - user has edited");
      return;
    }
